...
if { [ catch {
            # rfc2544.latency { sender receiver frameSize frameRate { testTime 120 } { iterations 20 } { timetowait 5 } { NAT 0 } { dutIP null }  }
            set result [ rfc2544.latency $sender $receiver $frameSize $frameRate ]
            puts  $fd "$result"
        } errorString ] } {
    puts $fd $errorString
    puts $errorString
