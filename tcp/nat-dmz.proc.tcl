...
proc tcp-nat-dmz.Setup { } {
    ...
    set httpServerPort [ $server Port.Create $::dmzPhysicalPort1 ]
    set httpClientPort [ $server Port.Create $::physicalPort1 ]
...
proc tcp-nat-dmz.Run { httpServer httpClient requestSize } {
