...
proc  BackToBackSetup { serverAddress publicPhysicalPort privatePhysicalPort publicMacAddress privateMacAddress publicIpConfig privateIpConfig publicUdpPort privateUdpPort ethernetLength flowParam } {
