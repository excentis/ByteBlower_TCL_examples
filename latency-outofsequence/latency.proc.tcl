...
#           a latency detector.
#
proc Latency.Setup { serverAddress srcPhysicalPort dstPhysicalPort srcMacAddress dstMacAddress srcIpConfig dstIpConfig srcUdpPort dstUdpPort ethernetLength flowParam } {
...
proc Latency.Execute { flowList } {
    ...
    return [ ::excentis::ByteBlower::FlowLatency $flowList -return numbers ]
}
...
#
proc Latency.Cleanup { server srcPort dstPort } {
