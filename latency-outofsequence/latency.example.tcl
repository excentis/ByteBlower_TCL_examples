...
source [ file join [ file dirname [ info script ]] latency.proc.tcl ]
...
set setup [ Latency.Setup $serverAddress $srcPort $dstPort $srcMacAddress $dstMacAddress \
...
Latency.Cleanup $srcPort $dstPort $flowList
puts "Cleanup done!"
